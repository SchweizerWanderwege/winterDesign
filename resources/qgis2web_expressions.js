...
function exp_Schneeschuhwanderwege_3rule0_eval_expression(context) {
    // IsCHM = 0

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('IsCHM')  == 0);
    } else {
        return (feature.get('IsCHM')  == 0);
    }
}
...
function exp_Schneeschuhwanderwege_3rule1_eval_expression(context) {
    // IsCHM = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('IsCHM')  == 1);
    } else {
        return (feature.get('IsCHM')  == 1);
    }
}
...
function exp_Winterwanderwege_5rule0_eval_expression(context) {
    // IsCHM = 0
...
function exp_Winterwanderwege_5rule1_eval_expression(context) {
    // IsCHM = 1
